    ...
    <div>
        <div className="child m-3 p-3 border-main">
            ...
            <form>
                ...
                <div className="form-group m-3">
                    <label htmlFor="exampleInputDate1 my-1">Date  of Birth</label>
                    <input type="date" className="form-control" id="exampleInputDate1" placeholder=""/>
                </div>
                <div className="form-group m-3">
                    <label htmlFor="exampleInputNumber1 my-1">Age</label>
                ...
                <div className="form-group m-3">
                    <label htmlFor="exampleInputState1 my-1">State</label>
        ...
        <div className="parents m-3 p-3 border-main">
            ...
            <div className="father my-5">
                ...
                <form>
                <div className="form-group m-3">
                    <label htmlFor="exampleInputName2 my-1">Name</label>
                ...
                <div className="form-group m-3">
                    <label htmlFor="exampleInputReligion2 my-1">Religion</label>
                ...
                <div className="form-group m-3">
                    <label htmlFor="exampleInputProfession2 my-1">Profession</label>
            ...
            <div className="mother mt-5">
                ...
                <form>
                <div className="form-group m-3">
                    <label htmlFor="exampleInputName3 my-1">Name</label>
                    <input type="name" className="form-control" id="exampleInputName3" placeholder=""/>
                </div>
                <div className="form-group m-3">
                    <label htmlFor="exampleInputNumber6 my-1">Age</label>
                    <input type="number" className="form-control" id="exampleInputNumber6" placeholder=""/>
                </div>
                <div className="form-group m-3">
                    <label htmlFor="exampleInputReligion3 my-1">Religion</label>
                ...
                <div className="form-group m-3">
                    <label htmlFor="exampleInputProfession3 my-1">Profession</label>
                ...
                <div className="form-group m-3">
                    <label htmlFor="exampleInputNumber7 my-1">Residence Number</label>
                ...
                <div className="form-group m-3">
                    <label htmlFor="exampleInputNumber9 my-1">Annual Income</label>
                    <input type="number" className="form-control" id="exampleInputNumber9" placeholder=""/>
                </div>
                <div className="form-group m-3">
                    <label htmlFor="exampleInputNumber10 my-1">Aadhar Card Number</label>
        ...
        <div className="family m-3 p-3 border-main">
            ...
            <form>
                ...
                <div className="siblings m-3 d-flex">
                        <p>Siblings :</p>
                        <div className="form-group m-3 ">
                            <label htmlFor="exampleInputNumber10 my-1">Brothers</label>
                            <input type="number" className="form-control" id="exampleInputNumber10" placeholder=""/>
                        </div>
                        <div className="form-group m-3">
                            <label htmlFor="exampleInputNumber10 my-1">Sisters</label>
                            <input type="number" className="form-control" id="exampleInputNumber10" placeholder=""/>
                        </div>
                </div>
